 ...
 * never will be) due to {@link Object.create} and
 * {@link Object.getOwnPropertyDescriptor}.
 */
/**
 * @namespace
 * @name grail
...
/**
 * Extends the prototype chain of {@link childCtor} from
 * {@link parentCtor.prototype}.
 * @param {!Function} childCtor The child class constructor.
 * @param {!Function} parentCtor The parent class constructor.
 * @return {!Function} The augmented {@link childCtor}.
 */
 ...
 * {@link scope} or calls the super method of {@link scope}. The method or super
 * constructor will be called with all arguments minus the first 2.
 * @param {!Object} scope
